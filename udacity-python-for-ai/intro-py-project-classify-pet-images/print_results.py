...
def print_results(results_dic, results_stats_dic, model, 
    ...
    print(f"Model architecture used: {model}\n")
    
    # Print general results statistics (counts)
    ...
    print(f"Percentage of Correct Dog Classifications: {results_stats_dic['pct_correct_dogs']:.2f}%")
    ...
    if print_incorrect_dogs and correct_dogs + incorrect_dogs != total_images:
        ...
        for key in results_dic:
            ...
            # Check if pet and classifier disagree on whether the image is a dog
            if sum(results_dic[key][3:]) == 1:
                pet_label = results_dic[key][0]
                classifier_label = results_dic[key][1]
                print(f"Image: {key}, Pet Label: {pet_label}, Classifier Label: {classifier_label}")
    ...
    if print_incorrect_breed and correct_dogs != correct_breeds:
        ...
        for key in results_dic:
            ...
            # Check if both agree it's a dog, but disagree on breed
            if sum(results_dic[key][3:]) == 2 and label_match == 0:
                pet_label = results_dic[key][0]
                classifier_label = results_dic[key][1]
                print(f"Image: {key}, Pet Label: {pet_label}, Classifier Label: {classifier_label}")
        print("")  # New line for separation
