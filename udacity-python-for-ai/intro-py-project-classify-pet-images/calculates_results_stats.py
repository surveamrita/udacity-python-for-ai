...
def calculates_results_stats(results_dic):
    ...
    for key in results_dic:
        ...
        # Count the number of dog images and non-dog images
        if pet_is_dog == 1:
            n_dogs_img += 1
            # Check if classifier also classifies as a dog
            if classifier_is_dog == 1:
                n_correct_dogs += 1
            # Check if the pet and classifier labels match and it's a dog
            if label_match == 1:
                n_correct_breed += 1
        else:
            n_notdogs_img += 1
    ...
    # Create the results_stats_dic dictionary
    results_stats_dic = {
        'n_images': n_images,
